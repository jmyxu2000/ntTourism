<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CarOrder.aspx.cs" Inherits="CarOrder" %>
...
<script type="text/javascript">
    ...
    function dataSave() {
        ...
        $.ajax({
            type: "POST",
            url: "CarOrderHandler.ashx",
            data: { "carcode": carcode, "membercode": membercode, "orderprice": orderprice, "begindate": begindate, "enddate": enddate, "cardnumber": cardnumber, "cvv": cvv, "cardholder": cardholder, "validthru": validthru, "action": "carorderadd" },
            dataType: "text",
            cache: false,
            beforeSend: function () { },
                        ...
                        <li>
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="location" value="<%=model.Location %>"/>
                                    </div>
                                    <div class="form-group">
                                        <asp:HiddenField ID="hidcarcode" runat="server" value=""/>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Car Type</label>
                                        <input class="form-control" type="text" id="carType" value ="<%=model.Cartype %>" />
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-3 col-md-offset-3">
                                    <div class="form-group">
                                        <input class="form-control" id="price" type="text" value ="<%=model.Budget.ToString("#.##") %>"/>
                                    </div>
                                </div>
                                <div class="col-md-3">
