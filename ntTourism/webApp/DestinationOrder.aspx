<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DestinationOrder.aspx.cs" Inherits="DestinationOrder" %>
...
<script type="text/javascript">
    ...
    function dataSave() {
        ...
        $.ajax({
            type: "POST",
            url: "DestinationOrderHandler.ashx",
            data: { "destinationcode": destinationcode, "membercode": membercode, "orderprice": orderprice, "date": date, "adultnum": adultnum, "cardnumber": cardnumber, "cvv": cvv, "cardholder": cardholder, "validthru": validthru, "action": "destinationorderadd" },
            dataType: "text",
            cache: false,
            beforeSend: function () { },
            ...
            <div class="paymemt-row-wrap">
                        ...
                        <li>
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="destinationName" value="<%=model.Destinationname %>"/>
                                    </div>
                                    <div class="form-group">
                                        <asp:HiddenField ID="hiddestinationcode" runat="server" value=""/>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-3 col-md-offset-3">
                                    <div class="form-group">
                                        <label>Price</label>
                                        <input class="form-control" id="price" type="text" value ="<%=model.Needmoney.ToString("#.##") %>"/>
                                    </div>
                                </div>
                                <div class="col-md-3">
                        ...
                        <li>
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="book_date">
                                        <label>Date</label>
                                        <input class="date" id="date" type="text" value="">
                                    </div>
                                </div>
                ...
                <div class="col-md-4">
                    <div class="booking-item-payment">
                        ...
                        <p class="booking-item-payment-total" id="totalprice">Total Money (AUD): $ <span id="totalmoney"></span>
                        </p>
                    </div>
                </div>
