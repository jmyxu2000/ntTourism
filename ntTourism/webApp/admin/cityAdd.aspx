<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cityAdd.aspx.cs" Inherits="admin_cityAdd" %>
    ...
    <script type="text/javascript">
        function dataSave() {
            ...
            $.ajax({
                ...
                data: { "citycode": citycode, "cityname": cityname, "seq": seq, "action": "cityadd" },
                dataType: "text",
                cache: false,
                beforeSend: function () { },
...
<body>
    <article class="page-container">
        <form method="post" class="form form-horizontal" runat="server">
            <asp:HiddenField ID="Hidcitycode" runat="server" />
            
            
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>city name：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="" placeholder="" id="cityname" name="cityname" runat="server">
                </div>
            </div>
