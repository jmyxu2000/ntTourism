<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editDestinationOrder.aspx.cs" Inherits="admin_editDestinationOrder" %>
...
<head>
    ...
    <title>edit destination order</title>
    ...
    <script type="text/javascript">
        function dataSave() {
            ...
            $.ajax({
                ...
                data: { "state": state, "ordercode": ordercode, "action": "destinationorderedit" },
                dataType: "text",
                cache: false,
                beforeSend: function () { },
