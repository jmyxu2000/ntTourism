<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editHotelOrder.aspx.cs" Inherits="admin_editHotelOrder" %>
    ...
    <script type="text/javascript">
        function dataSave() {
            ...
            $.ajax({
                ...
                data: { "state": state, "ordercode": ordercode, "action": "hotelorderedit" },
                dataType: "text",
                cache: false,
                beforeSend: function () { },
