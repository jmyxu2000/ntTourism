<%@ Page Language="C#" AutoEventWireup="true" CodeFile="listCarOrder.aspx.cs" Inherits="admin_listCarOrder" %>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<thead>
			<tr class="text-c">
                ...
                <th width="80">Pickup Location</th>
		...
		<tbody>
			...
			<tr class="text-c">
                ...
                <td><%#Eval("state") %></td>
                <td>
				<a title="edit" href="javascript:;" onclick="member_edit('edit','editCarOrder.aspx?getid=<%#Eval("ordercode")%>','4','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> 
...
<script type="text/javascript">
    ...
    function search() {
        ...
        location.href = "listCarOrder.aspx?membername=" + name;
    }
