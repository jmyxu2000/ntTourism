<%@ Page Language="C#" AutoEventWireup="true" CodeFile="listDestinationOrder.aspx.cs" Inherits="admin_listDestinationOrder" %>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			...
			<tr class="text-c">
                ...
                <td><%#Eval("state") %></td>
                <td>
				<a title="edit" href="javascript:;" onclick="member_edit('edit','editDestinationOrder.aspx?getid=<%#Eval("ordercode")%>','4','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> 
